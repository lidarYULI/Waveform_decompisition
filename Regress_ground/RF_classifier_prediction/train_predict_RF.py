...
from Regress_ground.Samples_generation import derivative_samples
...
if __name__ == '__main__':
    ...
    ### the classification method has been abandoned
    ### please regression method for ground return mode prediction
    train_by_elevation_samples()

    train_by_manual_samples()

    RF_predict_bysite(file_path.RF_excel, file_path.RF_classifier_save_dir)
